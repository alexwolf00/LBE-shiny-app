...
```{r, echo=FALSE}
c(lampreia=shapiro.test(dados.all$lampreia)$p.value, sável=shapiro.test(dados.all$savel)$p.value, enguias=shapiro.test(dados.all$enguias)$p.value, outros=shapiro.test(dados.all$outros.peixes.agua.doce)$p.value)
```
